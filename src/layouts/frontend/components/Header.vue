        ...
        <div class="flex items-center md:order-2">
          ...
          <div class="relative hidden mr-10 md:block">
            ...
            >
              ...
              <span class="px-2 py-[1px] flex-none text-xs border text-gray-400 rounded"
                >Ctrl K</span
              >
            </button>
          </div>
      ...
      <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
                ...
                <li>
                  <a
                    ...
                    />
                    <div class="text-gray-600 dark:text-gray-400">
                      <h2 class="text-base font-normal text-gray-900">测试</h2>
                      <span
                        class="inline-flex items-center text-xs font-normal text-gray-500 dark:text-gray-400"
                        ><svg
                          class="inline w-2.5 h-2.5 mr-2 text-gray-400 dark:text-white"
          ...
          <div class="p-4 md:p-5 border-t text-xs flex items-center text-gray-400">
            ...
            <span class="ml-auto"
              >基于
              <a href="https://lucene.apache.org/" target="_blank" class="underline"
                >Apache Lucene</a
              >
              全文检索引擎开发</span
            >
